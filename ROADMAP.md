...
- [x] AIAvatarStackChan-derived firmware runtime under `firmware/stackchan-runtime`
- [x] AIAvatarStackChan-style generated `/config.json` for firmware flashing
- [ ] Real StackChan speaker playback codec validation
