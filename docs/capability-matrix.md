...
| Zone view export | CLI | `iroharness view export` | Creates public/trusted/owner runtime views with allowlisted files, redacted connection metadata, and zone-filtered Project OS snapshots. |
